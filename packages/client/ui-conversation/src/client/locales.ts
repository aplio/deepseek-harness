...
export const zh = {
  ...
  'settings.enter.description': 'Enter 换行；此处设置智能体运行时发送按钮与 Cmd/Ctrl+Enter 的行为',
...
export const en = {
  ...
  'settings.enter.description': 'Enter inserts a line break; this sets what the Send button and Cmd/Ctrl+Enter do while the agent is running',
